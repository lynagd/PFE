...
import { User, Truck, Home, Settings, Bike } from "lucide-react";

const navItems = [
  { to: "/livreur/profile", label: "Profil", icon: <User className="inline mr-1" /> },
  { to: "/livreur/pharmacies", label: "Pharmacies", icon: <Home className="inline mr-1" /> },
  { to: "/livreur/commandes", label: "Livraisons", icon: <Truck className="inline mr-1" /> },
  { to: "/livreur/parametres", label: "Paramètres", icon: <Settings className="inline mr-1" /> },
];
